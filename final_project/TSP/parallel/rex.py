...
Temps = rexlib.getTemps(10, 100, 8)
rex = rexlib.REX(ReplicaClass = TSP, Temps = Temps, EquilSteps = 100, ProdSteps = 200000, StepFreq = 10, SwapFreq = 100, SwapsPerCycle = 5, DATADIR = os.path.abspath('./test'), Verbose = True)
rex.Run()
rex.demux(0)
